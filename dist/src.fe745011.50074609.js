...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src.fe745011.js":[function(require,module,exports) {
var define;
...
parcelRequire = function (e, r, t, n) {
    ...
    !function (e, t) {
      ...
      (w.fn.init = function (e, t, n) {
        ...
        if (n = n || j, "string" == typeof e) {
          ...
          if (r[1]) {
            if (t = t instanceof w ? t[0] : t, w.merge(this, w.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : y, !0)), N.test(r[1]) && w.isPlainObject(t)) for (r in t) {
                ...
                return function () {
                  var s = this,
                    ...
                    if (!(e < o)) {
                      ...
                      l = t && ("object" == _typeof(t) || "function" == typeof t) && t.then, g(l) ? i ? l.call(t, a(o, n, R, i), a(o, n, M, i)) : (o++, l.call(t, a(o, n, R, i), a(o, n, M, i), a(o, n, R, n.notifyWith))) : (r !== R && (s = void 0, u = [t]), (i || n.resolveWith)(s, u));
                    }
                  },
                      c = i ? l : function () {
                    try {
      ...
      w.extend({
        ...
        clone: function clone(e, t, n) {
          var r,
              ...
              c = e.cloneNode(!0),
              f = ie(e);
          if (!(h.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e))) for (a = ye(c), r = 0, i = (o = ye(e)).length; r < i; r++) {
      ...
      w.extend({
        ...
        style: function style(e, t, n, r) {
          if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
            ...
            "string" === (o = _typeof(n)) && (i = te.exec(n)) && i[1] && (n = se(e, t, i), o = "number"), null != n && n == n && ("number" !== o || u || (n += i && i[3] || (w.cssNumber[s] ? "" : "px")), h.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u ? l.setProperty(t, n) : l[t] = n));
          }
        },
      ...
      w.extend(w.event, {
        trigger: function trigger(e, n, r, i) {
          var o,
              a,
              s,
              u,
          ...
          if (a = d = s = r = r || y, 3 !== r.nodeType && 8 !== r.nodeType && !xt.test(m + w.event.triggered) && (m.indexOf(".") > -1 && (x = m.split("."), m = x.shift(), x.sort()), l = m.indexOf(":") < 0 && "on" + m, (e = e[w.expando] ? e : new w.Event(m, "object" == _typeof(e) && e)).isTrigger = i ? 2 : 3, e.namespace = x.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), n = null == n ? [e] : w.makeArray(n, [e]), p = w.event.special[m] || {}, i || !p.trigger || !1 !== p.trigger.apply(r, n))) {
            if (!i && !p.noBubble && !v(r)) {
            ...
            for (o = 0; (a = h[o++]) && !e.isPropagationStopped();) {
              d = a, e.type = o > 1 ? u : p.bindType || m, (c = (Y.get(a, "events") || Object.create(null))[e.type] && Y.get(a, "handle")) && c.apply(a, n), (c = l && a[l]) && c.apply && V(a) && (e.result = c.apply(a, n), !1 === e.result && e.preventDefault());
            }
  ...
  "QCba": [function (require, module, exports) {
    ...
    !function () {
      var e;
      null === (e = t.default("a")) || void 0 === e || e.click(function () {
        var e,
            o = t.default(this).attr("href");
        return t.default("html, body").animate({
          scrollTop: null === (e = t.default(o).offset()) || void 0 === e ? void 0 : e.top
        }, 800), !1;
      });
    }(), function () {
      function e() {
        var e,
            o = null === (e = t.default(document)) || void 0 === e ? void 0 : e.scrollTop(),
            a = window.innerHeight / 2,
            n = o <= a ? (a - o) / a : 0;
        console.log("estou no animateTest, meu opacityLevel é: " + n + " " + o);
        var i,
            l = document.getElementById("fadeout-animate");
        o > 0 ? (i = document.getElementById("navbar-boder"), console.log("Top is: " + i.style.marginTop), "0px" != i.style.marginTop && (i.style.marginTop = "0px", i.animate([{
          marginTop: "-60px",
          easing: "ease-out"
        }, {
          marginTop: "0px"
          ...
          duration: 750,
          iterations: 1
        })), l.setAttribute("style", "opacity: " + n), l.classList.remove("animate-pulse")) : (!function () {
          var e = document.getElementById("navbar-boder");
          "-60px" != e.style.marginTop && (e.style.marginTop = "-60px", e.animate([{
            marginTop: "0px",
            easing: "ease-out"
          }, {
            marginTop: "-60px"
      ...
      var o = t.default(".anime-left, .anime-right"),
          a = "anime-final",
          n = .75 * t.default(window).height();
      t.default(document).scroll(function () {
        var i;
        e(), i = t.default(document).scrollTop(), o.each(function () {
          var e,
              o = null === (e = t.default(this).offset()) || void 0 === e ? void 0 : e.top;
          console.log("Offset is " + n + "\n documentTop is " + i + "\n itemTop is " + o), i > o - n ? (console.log("Adicionando anime-final"), t.default(this).addClass(a)) : t.default(this).removeClass(a);
        });
      });
    }();
  }, {
